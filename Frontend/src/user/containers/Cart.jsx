                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div className="cart-anchor-image">
                                                        <a href="single-product.html">
                                                            <img src="/src/assets/images/product/product-1.jpg" alt="Product" />
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="cart-anchor-image">
                                                        <a href="single-product.html">
                                                            <img src="/src/assets/images/product/product-14.jpg" alt="Product" />
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="cart-anchor-image">
                                                        <a href="single-product.html">
                                                            <img src="/src/assets/images/product/product-29.jpg" alt="Product" />
                                                ...
                                                <td>
                                                    <div className="action-wrapper">
                                                        <button className="button button-outline-secondary fas fa-sync" />
                                                        <button className="button button-outline-secondary fas fa-trash u-s-m-l-8" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div className="cart-anchor-image">
                                                        <a href="single-product.html">
                                                            <img src="/src/assets/images/product/product-39.jpg" alt="Product" />
