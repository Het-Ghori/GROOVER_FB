                                    ...
                                    <div className="slider-fouc">
                                        <div className="products-slider owl-carousel" data-item={4}>
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-1.jpg" alt="Product" />
                                                    </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-2.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-3.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-4.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-5.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-6.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-7.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-8.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                    ...
                    <div className="slider-fouc">
                        <div className="products-slider owl-carousel" data-item={4}>
                            <div className="item">
                                <div className="image-container">
                                    <a className="item-img-wrapper-link" href="single-product.html">
                                        <img className="img-fluid" src="/src/assets/images/product/product-9.jpg" alt="Product" />
                                    </a>
                                    <div className="item-action-behaviors">
                            ...
                            <div className="item">
                                <div className="image-container">
                                    <a className="item-img-wrapper-link" href="single-product.html">
                                        <img className="img-fluid" src="/src/assets/images/product/product-10.jpg" alt="Product" />
                                    </a>
                                    <div className="item-action-behaviors">
                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                            ...
                            <div className="item">
                                <div className="image-container">
                                    <a className="item-img-wrapper-link" href="single-product.html">
                                        <img className="img-fluid" src="/src/assets/images/product/product-11.jpg" alt="Product" />
                                    </a>
                                    <div className="item-action-behaviors">
                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                            ...
                            <div className="item">
                                <div className="image-container">
                                    <a className="item-img-wrapper-link" href="single-product.html">
                                        <img className="img-fluid" src="/src/assets/images/product/product-12.jpg" alt="Product" />
                                    </a>
                                    <div className="item-action-behaviors">
                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
            ...
            <div className="banner-image-view-more">
                <div className="container">
                    <div className="image-banner u-s-m-y-40">
                        <a href="shop-v1-root-category.html" className="mx-auto banner-hover effect-dark-opacity">
                            <img className="img-fluid" src="/src/assets/images/banners/ban-men.jpg" alt="Men Banner" />
                        </a>
                    </div>
                                    ...
                                    <div className="slider-fouc">
                                        <div className="products-slider owl-carousel" data-item={4}>
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-13.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-14.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-15.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-16.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-17.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-18.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-19.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-20.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                    ...
                                    <div className="slider-fouc">
                                        <div className="products-slider owl-carousel" data-item={4}>
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-21.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-22.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-23.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-24.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-25.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-26.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-27.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-28.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                                    ...
                                                    <div className="slider-fouc">
                                                        <div className="specific-category-slider owl-carousel" data-item={3}>
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-29.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-30.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-31.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-32.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                    ...
                                                    <div className="slider-fouc">
                                                        <div className="specific-category-slider owl-carousel" data-item={3}>
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-33.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-34.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-35.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-36.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                    ...
                                                    <div className="slider-fouc">
                                                        <div className="specific-category-slider owl-carousel" data-item={3}>
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-37.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-38.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-39.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-40.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                    ...
                                                    <div className="slider-fouc">
                                                        <div className="specific-category-slider owl-carousel" data-item={3}>
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-41.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-42.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-43.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                                            ...
                                                            <div className="item">
                                                                <div className="image-container">
                                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                                        <img className="img-fluid" src="/src/assets/images/product/product-44.jpg" alt="Product" />
                                                                    </a>
                                                                    <div className="item-action-behaviors">
                                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                                                        <a className="item-mail" href="javascript:void(0)">Mail</a>
                                    ...
                                    <div className="slider-fouc">
                                        <div className="products-slider owl-carousel" data-item={4}>
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-45.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-46.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-47.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                                            ...
                                            <div className="item">
                                                <div className="image-container">
                                                    <a className="item-img-wrapper-link" href="single-product.html">
                                                        <img className="img-fluid" src="/src/assets/images/product/product-48.jpg" alt="Product" />
                                                    </a>
                                                    <div className="item-action-behaviors">
                                                        <a className="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look
                                                        </a>
                ...
                <div className="container">
                    <div className="brand-slider-content owl-carousel" data-item={5}>
                        <div className="brand-pic">
                            <a href="#">
                                <img src="/src/assets/images/brand-logos/b1.png" alt="Brand 1" />
                            </a>
                        </div>
                        <div className="brand-pic">
                            <a href="#">
                                <img src="/src/assets/images/brand-logos/b2.png" alt="Brand 2" />
                            </a>
                        </div>
                        <div className="brand-pic">
                            <a href="#">
                                <img src="/src/assets/images/brand-logos/b3.png" alt="Brand 3" />
                            </a>
                        </div>
                        <div className="brand-pic">
                            <a href="#">
                                <img src="/src/assets/images/brand-logos/b4.png" alt="Brand 4" />
                            </a>
                        </div>
                        <div className="brand-pic">
                            <a href="#">
                                <img src="/src/assets/images/brand-logos/b5.png" alt="Brand 5" />
                            </a>
                        </div>
                        <div className="brand-pic">
                            <a href="#">
                                <img src="/src/assets/images/brand-logos/b6.png" alt="Brand 6" />
                            </a>
                        </div>
                    </div>
                </div>
