                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="zoom-area">
                                <img id="zoom-pro" className="img-fluid" src="/src/assets/images/product/product-1@4x-1.jpg" data-zoom-image="images/product/product-1@4x-1.jpg" alt="Zoom Image" />
