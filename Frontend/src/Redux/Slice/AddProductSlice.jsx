...
export const fetchProduct = createAsyncThunk(
    ...
    async () => {
        const response = await fetch("http://localhost:3000/api/product/list-product/");
...
export const putProduct = createAsyncThunk(
    ...
    async ({ productId, data }) => {
        try {
            const response = await axios.put(`http://localhost:3000/api/product/update-product/${productId}`, data);
            return response.data;
        } catch (error) {
            throw error;
        }
...
export const deleteProduct = createAsyncThunk(
    ...
    async (productId) => {
        try {
           let response = await axios.delete(`http://localhost:3000/api/product/delete-product/${productId}`);
