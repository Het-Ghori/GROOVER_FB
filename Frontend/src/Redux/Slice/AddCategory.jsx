...
export const fetchCategory = createAsyncThunk(
    ...
    async () => {
        const response = await fetch("http://localhost:3000/api/category/list-category/");
...
export const putCategory = createAsyncThunk(
    ...
    async ({ categoryId, data }) => {
        try {
            const response = await axios.put(`http://localhost:3000/api/category/update-category/${categoryId}`, data);
...
export const deleteCategory = createAsyncThunk(
    ...
    async (categoryId) => {
        try {
           let response = await axios.delete(`http://localhost:3000/api/category/delete-category/${categoryId}`);
