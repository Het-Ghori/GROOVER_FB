...
export const fetchSubcategory = createAsyncThunk(
    ...
    async () => {
        const response = await fetch("http://localhost:3000/api/subcategory/get-subcategory/");
...
export const postSubcategory = createAsyncThunk(
    ...
    async (data) => {
        try {
            const response = await axios.post("http://localhost:3000/api/subcategory/create-subcategory/", data);
...
export const putSubcategory = createAsyncThunk(
    ...
    async ({ subcategoryId, data }) => {
        try {
            const response = await axios.put(`http://localhost:3000/api/subcategory/update-subcategory/${subcategoryId}`, data);
...
export const deleteSubcategory = createAsyncThunk(
    ...
    async (subcategoryId) => {
        try {
           let response = await axios.delete(`http://localhost:3000/api/subcategory/delete-subcategory/${subcategoryId}`);
